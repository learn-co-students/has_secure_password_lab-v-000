...
RSpec.describe SessionsController, type: :controller do
  ...
  describe 'post create' do
    it 'logs you in with the correct password' do
      ...
      #### Using Form_for :session ####
      post :create, session: {name: connie.name, password: connie.password}
    ...
    #### Using Form_for :session ####
    post :create, session: {name: connie.name, password: connie.password + 'x'}
    ...
    it 'rejects empty passwords' do
      ...
      #### Using Form_for :session ####
      post :create, session: {name: connie.name, password: ''}
      expect(session[:user_id]).to be_nil
    end
  end
end
